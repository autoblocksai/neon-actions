...
const parseEndpointConfigFromInputs = () => {
    const zEndpointConfigSchema = zod_1.z.object({
        ...
        'INPUT_ENDPOINT-TYPE': zod_1.z.enum(['read_write', 'read_only']),
        'INPUT_ENDPOINT-SUSPEND-TIMEOUT-SECONDS': zod_1.z.coerce
            .number()
            .int()
            .min(-1)
            .max(604800),
        'INPUT_ENDPOINT-AUTOSCALING-LIMIT-MIN-CU': zod_1.z.coerce.number().min(0.25),
        'INPUT_ENDPOINT-AUTOSCALING-LIMIT-MAX-CU': zod_1.z.coerce.number().min(0.25),
    });
    return zEndpointConfigSchema.parse(process.env);
};
const getOrCreateBranch = (neon, neonBranchName) => __awaiter(void 0, void 0, void 0, function* () {
    const existingBranch = yield neon.getBranchByName(neonBranchName);
    if (existingBranch) {
        console.log(`Branch '${neonBranchName}' already exists, skipping creation`);
        const endpoint = yield neon.getEndpointForBranch(existingBranch.id);
        return {
        ...
        const createdBranch = yield neon.createBranch({
            name: neonBranchName,
            endpointType: config['INPUT_ENDPOINT-TYPE'],
            endpointSuspendTimeoutSeconds: config['INPUT_ENDPOINT-SUSPEND-TIMEOUT-SECONDS'],
            endpointAutoscalingLimitMinCu: config['INPUT_ENDPOINT-AUTOSCALING-LIMIT-MIN-CU'],
            endpointAutoscalingLimitMaxCu: config['INPUT_ENDPOINT-AUTOSCALING-LIMIT-MAX-CU'],
        });
        console.log(`Created new branch:`);
        console.log((0, util_1.prettyPrint)(createdBranch));
        return {
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    const neon = new util_1.NeonSDK();
    const neonBranchName = (0, util_1.makeNeonBranchName)();
    const { branchId, endpoint } = yield getOrCreateBranch(neon, neonBranchName);
    actions.notice(`Your Neon branch is at ${neon.makeBranchHtmlUrl(branchId)}`);
    yield neon.waitForBranchToBeReady(branchId);
    yield neon.waitForEndpointToBeReady(endpoint.id);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.NeonSDK = exports.makeNeonBranchName = exports.makeNeonBranchNamePrefix = exports.sleep = exports.prettyPrint = void 0;
...
const zEnvSchema = zod_1.z.object({
    // GitHub Actions inputs are converted to environment variables prefixed with INPUT_
    // https://docs.github.com/en/actions/creating-actions/metadata-syntax-for-github-actions#inputs
    'INPUT_API-KEY': zod_1.z.string().nonempty(),
    'INPUT_PROJECT-ID': zod_1.z.string().nonempty(),
    // Default environment variables during a GitHub Actions run
    // https://docs.github.com/en/actions/learn-github-actions/variables#default-environment-variables
    GITHUB_SHA: zod_1.z.string().nonempty(),
    GITHUB_EVENT_NAME: zod_1.z.enum(['pull_request', 'push', 'delete']),
    GITHUB_EVENT_PATH: zod_1.z.string().nonempty(),
});
const env = zEnvSchema.parse(process.env);
// https://docs.github.com/en/webhooks/webhook-events-and-payloads#pull_request
const zPullRequestSchema = zod_1.z.object({
    pull_request: zod_1.z.object({
        head: zod_1.z.object({
            ref: zod_1.z.string().nonempty(),
            sha: zod_1.z.string().nonempty(),
        }),
    }),
});
// https://docs.github.com/en/webhooks/webhook-events-and-payloads#push
const zPushSchema = zod_1.z.object({
    ref: zod_1.z.string().nonempty(),
});
...
const getRef = () => {
    ...
    const rawEvent = JSON.parse(fs_1.default.readFileSync(env.GITHUB_EVENT_PATH, 'utf8'));
...
const makeNeonBranchNamePrefix = () => {
    return `${getRefName()}-`;
};
exports.makeNeonBranchNamePrefix = makeNeonBranchNamePrefix;
const makeNeonBranchName = () => {
    return (0, exports.makeNeonBranchNamePrefix)() + env.GITHUB_SHA.slice(0, 7);
};
exports.makeNeonBranchName = makeNeonBranchName;
// Schema of Neon branches
// https://api-docs.neon.tech/reference/getprojectbranch
const zBranchSchema = zod_1.z.object({
    id: zod_1.z.string().nonempty(),
    project_id: zod_1.z.string().nonempty(),
    parent_id: zod_1.z.string().nonempty().optional(),
    name: zod_1.z.string().nonempty(),
    current_state: zod_1.z.enum(['init', 'ready']),
});
// Schema of Neon endpoints
// https://api-docs.neon.tech/reference/getprojectendpoint
const zEndpointSchema = zod_1.z.object({
    id: zod_1.z.string().nonempty(),
    host: zod_1.z.string().nonempty(),
    current_state: zod_1.z.enum(['init', 'active', 'idle']),
});
class NeonSDK {
    constructor() {
        this.baseUrl = 'https://console.neon.tech';
    ...
    retryFn(args) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield args.fn();
            }
            catch (error) {
                if (args.retries === 0) {
                    actions.error(`Timed out retrying:\n${(0, exports.prettyPrint)(error)}`);
                    throw error;
                }
                console.log(`Retrying in ${args.delaySeconds} seconds (${args.retries} retries left)`);
                yield (0, exports.sleep)(args.delaySeconds * 1000);
                return this.retryFn({
                    fn: args.fn,
    ...
    makeBranchHtmlUrl(branchId) {
        return `${this.baseUrl}/app/projects/${env['INPUT_PROJECT-ID']}/branches/${branchId}`;
    }
    getBranch(branchId) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data: { branch: branchRaw }, } = yield this.client.get(`/branches/${branchId}`);
    ...
    createBranch(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const fn = () => __awaiter(this, void 0, void 0, function* () {
                const { data } = yield this.client.post('/branches', {
                    branch: {
                        name: args.name,
                    },
                    endpoints: [
                ...
                return {
                    ...
                    endpoints: zod_1.z.array(zEndpointSchema).parse(data.endpoints),
                };
            });
            return this.retryFn({
                fn,
    ...
    deleteBranch(branchId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.client.delete(`/branches/${branchId}`);
        });
    }
    getEndpoint(endpointId) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data: { endpoint: endpointRaw }, } = yield this.client.get(`/endpoints/${endpointId}`);
            return zEndpointSchema.parse(endpointRaw);
        });
    }
    getBranches() {
        return __awaiter(this, void 0, void 0, function* () {
            const { data: { branches: branchesRaw }, } = yield this.client.get('/branches');
            const branches = zod_1.z.array(zBranchSchema).parse(branchesRaw);
    ...
    getEndpointForBranch(branchId) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data: { endpoints: endpointsRaw }, } = yield this.client.get(`/branches/${branchId}/endpoints`);
            const endpoints = zod_1.z.array(zEndpointSchema).parse(endpointsRaw);
    ...
    waitForBranchToBeReady(branchId) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(`Wating for branch ${branchId} to be ready`);
            const fn = () => __awaiter(this, void 0, void 0, function* () {
                const branch = yield this.getBranch(branchId);
    ...
    waitForEndpointToBeReady(endpointId) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(`Wating for endpoint ${endpointId} to be ready`);
            // Start the endpoint
            try {
                yield this.client.post(`/endpoints/${endpointId}/start`);
            }
            catch (_a) {
            ...
            const fn = () => __awaiter(this, void 0, void 0, function* () {
                const endpoint = yield this.getEndpoint(endpointId);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(6719);
