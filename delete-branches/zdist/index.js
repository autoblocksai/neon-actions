...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const neonBranchNamePrefix = (0, util_1.makeNeonBranchNamePrefix)();
    const branches = yield neon.getBranches();
    console.log(`Found ${branches.length} branches:`);
    branches.forEach((branch) => {
        console.log(`  ${branch.name} (${branch.id})`);
    });
    const branchesToDelete = branches.filter((branch) => branch.name.startsWith(neonBranchNamePrefix));
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(6164);
